...
const WorkerDiffSchema = new mongoose_1.Schema({
...
const ProjectRevisionSchema = new mongoose_1.Schema({
...
exports.default = mongoose_1.default.model('ProjectRevision', ProjectRevisionSchema);
